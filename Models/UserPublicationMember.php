...
class UserPublicationMember extends Model
{
    ...
    /**
     * Get the publication that owns the UserPublicationMember
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
    public function publication()
    {
        return $this->belongsTo(UserPublication::class, 'user_publication_id');
    }
}
