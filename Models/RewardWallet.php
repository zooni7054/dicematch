...
class RewardWallet extends Model
{
    ...
    /**
     * Get the user that owns the RewardWallet
     *
    ...
    /**
     * Get all of the transactions for the RewardWallet
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     */
    public function transactions()
    {
        return $this->hasMany(RewardWalletTransaction::class, 'reward_wallet_id', 'id');
    }
}
