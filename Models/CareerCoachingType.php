...
class CareerCoachingType extends Model
{
    ...
    /**
     * Get all of the booking for the CareerCoachingType
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     */
    public function booking()
    {
        return $this->hasMany(CareerCoachingBooking::class, 'career_coaching_type_id', 'id');
    }
