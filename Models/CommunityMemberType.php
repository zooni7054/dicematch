...
class CommunityMemberType extends Model
{
    ...
    /**
     * Get all of the members for the CommunityMemberType
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     */
    public function members()
    {
        return $this->hasMany(CommunityMember::class, 'community_member_type_id', 'id');
    }
}
