...
class Language extends Model
{
    ...
    /**
     * The language that belong to the User
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsToMany
     */
    public function users()
    {
        return $this->belongsToMany(User::class, 'language_user')->withPivot(['reading_scale','listening_scale', 'writing_scale', 'speaking_scale']);
    }
}
